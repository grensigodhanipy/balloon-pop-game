...
######################################################################################
#Images
ImgBalloon = pygame.image.load('E:/GRENSI/project/Ballon Pop (Pygame) (1)/Ballon Pop (Pygame)/Images_Project/BalloonRed.png').convert_alpha()

ImgBalloon_2 = pygame.image.load('E:/GRENSI/project/Ballon Pop (Pygame) (1)/Ballon Pop (Pygame)/Images_Project/BalloonBlue.png').convert_alpha()
ImgBalloon_2 = pygame.transform.scale(ImgBalloon_2,(115,200))

ImgBalloon_3 = pygame.image.load('E:/GRENSI/project/Ballon Pop (Pygame) (1)/Ballon Pop (Pygame)/Images_Project/BalloonMultiColor.png').convert_alpha()
ImgBalloon_3 = pygame.transform.scale(ImgBalloon_3,(200,250))

ImgPop = pygame.image.load('E:/GRENSI/project/Ballon Pop (Pygame) (1)/Ballon Pop (Pygame)/Images_Project/Pop.png').convert_alpha()
...
while Start:
    ...
    if hands:                      #Checking for the Hands
        ...
        if len(hands)>1:
            if BalloonRect.collidepoint(x1, y1):      #If Collide then Restart the Balloon, Increase Speed and Score
                ResetBalloon()
                window.blit(ImgPop,(x1-75,y1-25))     #Displaying the Popped Imaged as balloon is bursted
                Score += 1
                Speed += 1

            if BalloonRect_2.collidepoint(x1, y1):      #If Collide then Restart the Balloon, Increase Speed and Score
                ResetBalloon_2()
                window.blit(ImgPop,(x1-75,y1-25))     #Displaying the Popped Imaged as balloon is bursted
                Score += 1
                Speed_2 += 1

            if BalloonRect_3.collidepoint(x1, y1):      #If Collide then Restart the Balloon, Increase Speed and Score
                ResetBalloon_3()
                window.blit(ImgPop,(x1-75,y1-25))     #Displaying the Popped Imaged as balloon is bursted
                Score += 5
                Speed_3 += 1
    ...
    if (Time < 0):          #If Time Over then
        font = pygame.font.Font('E:/GRENSI/project/Ballon Pop (Pygame) (1)/Ballon Pop (Pygame)/Images_Project/Marcellus-Regular.ttf',50)
        ...
        font_goback = pygame.font.Font('E:/GRENSI/project/Ballon Pop (Pygame) (1)/Ballon Pop (Pygame)/Images_Project/Marcellus-Regular.ttf',50)
